module.exports = {
    ...
    accountNavSettings: '.c-header__button-wrapper > div:nth-child(3) div:nth-child(4) > h3',
        ...
        accountNavAccSettingsLink: '.c-header__button-wrapper > div:nth-child(3) > div > div > div > div:nth-child(4) > ul > li:nth-child(1) > a',
        accountNavTaxReceipts: '.c-header__button-wrapper > div:nth-child(3) > div > div > div > div:nth-child(4) > ul > li:nth-child(2) > a',
        accountNavGivingTools: '.c-header__button-wrapper > div:nth-child(3) > div > div > div > div:nth-child(4) > ul > li:nth-child(3) > a',
        accountNavLogout: '.c-header__button-wrapper > div:nth-child(3) > div > div > div > div:nth-child(4) > ul > li:nth-child(4) > a',
