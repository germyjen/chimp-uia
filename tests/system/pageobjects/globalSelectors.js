module.exports = {
    ...
    btnStart: 'body > header > div > div > div.row > div.small-6.columns.text-right > a',
    btnDiscover: 'body > header > div > div > div.row > div.small-6.columns.text-left > a',
    ...
    highlightsTitle: 'body > section.c-section.c--highlights > div > div:nth-child(2) > div > div.c-highlight__title.c--center > div',
    highlightsBody: '.c-highlight__body',
    highlightsBtn: 'body > section.c-section.c--highlights > div > div:nth-child(2) > div > div.c-highlight__body > a',
